									...
									<div className="p-6 flex-1">
										...
										<div className="flex items-center justify-end pt-4 border-t border-gray-100">
											<motion.button
												...
												whileTap={{ scale: 0.95 }}
												className="px-4 py-2 bg-myZoneOnline text-white rounded-xl hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg flex items-center gap-2 text-sm font-medium"
												onClick={(e) => {
													e.stopPropagation()
